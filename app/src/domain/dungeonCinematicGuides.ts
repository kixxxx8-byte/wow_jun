...
export const dungeonCinematicGuides: Record<string, DungeonCinematicGuide> = {
  windrunner: {
    ...
    oneLineKo: "회오리 길을 먼저 보고, 갈고리는 칼리스에게 맞추고, 화살은 늦지 않게 밟습니다.",
    survivalFocusKo: [
      "광풍 중에는 딜보다 회오리 길 찾기가 먼저입니다.",
      "칼리스 광역 시전은 내장 걸쇠 갈고리로 끊는 패턴입니다.",
    ...
    phases: [
      ...
      },
      {
        ...
        phaseKo: "갈고리로 광역 차단",
        bossKo: "칼리스 & 내장 걸쇠",
        oneLineKo: "갈고리 대상이면 칼리스 쪽으로 들어가 광역 시전을 끊습니다.",
        watchKo: "칼리스 캐스팅 바, 내장 걸쇠 갈고리 대상, 두 보스 체력",
        moveKo: "갈고리 대상자는 칼리스와 내장 걸쇠 사이 안전 라인으로 이동",
        interruptKo: "일반 발차기보다 갈고리 유도가 핵심. 보조로 스턴/실명 준비",
